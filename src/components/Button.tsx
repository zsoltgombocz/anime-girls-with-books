...
export default function Button({ text, redirect, icon }: ButtonInterface) {
    ...
    const baseClasses = classNames(
        'inline-block py-2 px-5 md:py-3 px-8 uppercase shadow-md border-2 border-primary text-primary z-10 relative rounded-md text-base md:text-lg font-bold flex items-center justify-center gap-3'
    );
